...
export class DestinationRule extends CustomResource {
    /** @internal */
    private static readonly __pulumiType = 'kubernetes:networking.istio.io/v1alpha3:DestinationRule';
     ...
     */
    public readonly spec: Output<output.networking.v1alpha3.DestinationRule>;
    ...
    /**
     * Create a networking.v1alpha3.DestinationRule resource with the given unique name, arguments, and options.
     *
    ...
    constructor(name: string, args: { metadata: types.input.meta.v1.ObjectMeta, spec: input.networking.v1alpha3.DestinationRule }, opts: CustomResourceOptions = {}) {
        const inputs: Inputs = {

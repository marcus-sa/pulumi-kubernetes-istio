...
export class Sidecar extends CustomResource {
     ...
     */
    public readonly spec: Output<output.networking.v1alpha3.SidecarSpec>;
    ...
    constructor(name: string, args: input.networking.v1alpha3.Sidecar, opts: CustomResourceOptions = {}) {
        const inputs: Inputs = {

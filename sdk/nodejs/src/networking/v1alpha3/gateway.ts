...
export class Gateway extends CustomResource {
    /** @internal */
    private static readonly __pulumiType = 'kubernetes:networking.istio.io/v1alpha3:Gateway';
    ...
    public static isInstance(obj: any): obj is Gateway {
        return obj != null && obj['__pulumiType'] === Gateway.__pulumiType;
    }

    /**
     * Create a networking.v1alpha3.Gateway resource with the given unique name, arguments, and options.
     *
